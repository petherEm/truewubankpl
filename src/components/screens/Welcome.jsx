    ...
    <div className="h-[820px] w-full md:w-[400px]">
      ...
      <div className="flex flex-col">
        <div className="flex flex-col px-4 text-white">
          ...
          <h1 className="mt-4 mb-4 text-2xl font-bold">Witaj Piotr</h1>
          ...
          <div className="mt-4 mb-4 flex items-center justify-between">
            <button onClick={() => router.push('/app/fundsin')} className="rounded-full bg-yellow-400 px-4 py-2 text-black hover:bg-yellow-600">
              Wpłać pieniądze
            </button>
