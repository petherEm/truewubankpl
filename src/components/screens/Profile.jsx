      ...
      <div className="flex flex-col">
        <div className="flex flex-col px-4 text-white">
          ...
          <div className="flex h-auto flex-col gap-4 bg-slate-100 p-6 text-black">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center justify-between">
                <h2 className="text-[10px]">
                  ...
                  Union Digital Bankingudostępniając swój profil w wyszukiwarce.
                </h2>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              <h1 className="mt-4 text-[12px] font-bold">Informacje prawne</h1>
              <div className="flex items-center justify-between">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between">
                <h2 className="text-[12px] font-bold">Potrzebujesz pomocy?</h2>
                <HiChevronRight className="text-[12px]" />
              </div>
              <div className="flex items-center justify-between">
            ...
            {/* LOGOUT */}
            <button className="w-[80%] mx-auto rounded-full border-2 border-black px-4 py-2 text-[10px] font-semibold">
              Wyloguj
            </button>
            <p className="text-center text-slate-500 text-[12px]">Wersja 5.39</p>
          </div>
        </div>
      </div>
