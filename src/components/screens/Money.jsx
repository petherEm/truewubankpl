        ...
        <div className="flex flex-col px-4 text-white">
          ...
          <div>
            ...
            <div className="bg-slate-100 p-2 text-black">
              ...
              <h2 className="mt-4 text-[12px] font-bold">Łącznie PLN Saldo</h2>
              <div>
              ...
              {/* OTHER CURRENCIES */}
              <div>
                <h1 className="mt-8 mb-4 text-xl font-bold">Konta walutowe</h1>
                <div className="">
                ...
                <div className="mt-4 flex flex-col items-center justify-center gap-4">
                  <p className="text-center text-[11px] text-black">
                    Masz <span className="font-bold">4</span> kont walutowych w
                    Twoim planie
                  </p>
